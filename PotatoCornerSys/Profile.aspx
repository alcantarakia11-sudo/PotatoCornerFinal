...
<head runat="server">
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-confirmed    { background: #d4edda; color: #155724; border: 1px solid #a5d6a7; }
        .status-out-delivery { background: #e3f2fd; color: #1565c0; border: 1px solid #90caf9; }
        .status-delivered    { background: #e3f2fd; color: #1565c0; border: 1px solid #64b5f6; }
        .status-picked-up    { background: #f3e5f5; color: #6a1b9a; border: 1px solid #ce93d8; }
...
<form id="form1" runat="server">
        ...
        <aside class="sidebar">
            ...
            <div class="profile-card" id="profileCardContainer" runat="server">
                ...
                <div class="profile-card-body">
                    ...
                    <div class="info-row" id="membershipRequestStatusRow" runat="server" visible="false">
                        <div class="info-row-label">Membership Request</div>
                        <div class="info-row-value">
                            <asp:Label ID="lblMembershipRequestStatus" runat="server" Text="Pending Confirmation" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="deleteAccountModal" class="modal-overlay">
        <div class="delete-modal-box">
            ...
            <div class="modal-btns">
                <button type="button" class="modal-btn-cancel-style" onclick="closeDeleteAccountModal()">Cancel</button>
